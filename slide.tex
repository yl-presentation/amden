...
\begin{frame}{Discovering Amorphous Materials with Desired Properties}
  ...
  \begin{itemize}
    ...
    \item Inevitably, a large number of material samples need to be created/generated, leading to high manpower, material, and time costs
  \end{itemize}
\end{frame}
...
\begin{frame}{Generative Modeling with Diffusion Models}
  A family of machine learning frameworks that generate data from random noise by denoising the data step-by-step.
  \begin{figure}[htbp]
...
\begin{frame}{Equivariant Neural Network Architecture}
  Update the positions and elements of atoms while preserving the geometric equivariance of amorphous material samples.
  \begin{figure}
    \centering
...
\begin{frame}{Density Control in the Generation Process}
  ...
  \begin{block}{Limitation of diffusion models}
    \begin{itemize}
      ...
      \item Adding or removing atoms from the system will be technically challenging for diffusion models
    \end{itemize}
  \end{block}
\end{frame}
  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item The model is able to generate compositionally accurate samples but falls short in generating structures accurately
      \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{figure}
...
\begin{frame}{Generation of Amorphous Silicon}
  ...
  \end{figure}
  \vspace{-1.5em}
  This further demonstrates that the model is unable to generate low-energy structures derived from relaxation processes.
\end{frame}

\begin{frame}{Limitations}
  \begin{block}{Generation of samples with relaxed structures}
    Unable to generate amorphous materials with relaxed structures, an inherent limitation of diffusion models.
  \end{block}
